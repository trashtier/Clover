 ...
 */
package org.trashtier.chan.ui.theme;
...
/**
 * A Theme<br>
 * Used for setting the toolbar color, and passed around {@link org.trashtier.chan.chan.ChanParser} to give the spans the correct color.<br>
